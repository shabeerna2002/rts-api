...
Namespace JobStation.DAL
    Public Class User
        ...
        Public Function CheckLoginUserInfo(ByRef con As MySqlConnection, ByRef MyTrans As MySqlTransaction, UserName As String, Password As String, UserTypeID As Integer) As DataSet

            Try
                Dim cmd As New MySqlCommand
                cmd.Parameters.Add("?p_user_name", MySqlDbType.VarChar)
                cmd.Parameters.Item("?p_user_name").Value = UserName



                cmd.Parameters.Add("?p_uPassword", MySqlDbType.VarChar)
                cmd.Parameters.Item("?p_uPassword").Value = JobStation.DatabaseCommands.Encrypt(Password)

                cmd.Parameters.Add("?p_UserTypeid", MySqlDbType.Int16)
                cmd.Parameters.Item("?p_UserTypeid").Value = UserTypeID


                Dim commandtext As String = "LoginUser"
                cmd.CommandType = Data.CommandType.StoredProcedure
                cmd.CommandText = commandtext
